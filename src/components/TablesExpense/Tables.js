...
const Tables = ({ userdata, deleteExpense, fetchExpData, handlePrevious, handleNext, page, pageCount, setPage }) => {
                            ...
                            <td>
                              <Dropdown className='text-center'>
                                ...
                                <Dropdown.Menu>
                                  ...
                                  <Dropdown.Item>
                                    <NavLink to={`/editexpense/${element._id}`} className="text-decoration-none" style={{ width: '100%', display: 'block !important' }} >
                                      <i className='fa-solid fa-pen-to-square' style={{ color: "blue" }}></i> <span>Edit</span>
                                    </NavLink>
                                  </Dropdown.Item>
                                  <Dropdown.Item>
                                    <div onClick={() => deleteExpense(element._id)}>
